...
CRITICAL FIX: Uses EnterpriseURLNormalizer instead of urljoin()
...
class LinkExtractor:
    ...
    def __init__(self, base_url: Optional[str] = None):
        ...
        # 🔥 CRITICAL FIX: Initialize EnterpriseURLNormalizer
    ...
    def _process_url(self, url_candidate: str) -> Optional[str]:
        ...
        CRITICAL FIX: Replaces urljoin() with EnterpriseURLNormalizer to properly
        handle embedded hostnames like /static.xx.fbcdn.net/...
